...
#' There is a check_zeroinflation function in the performance package 
  performance::check_zeroinflation(fit.pois)
  
#' Let's conduct a goodness-of-fit test using the number of zeros 
#' in the data as our test-statistic!
...
#+ fig.height = 5, fig.width = 6, out.width = "55%", fig.alt = "Predictive distribution for number of zeros"
(T<-sum(slugs$slugs==0)) # T for our data
