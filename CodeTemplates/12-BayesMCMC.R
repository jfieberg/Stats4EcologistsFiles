...
#' Or, to take advantage of parallel processing, but then compile report doesn't work
...
#' ## Rendering
#' 
#' For some reason, I am unable to compile into an html file (when I try, R can't
#' find JAGS). I can use the following approach instead:
#' 
#' rmarkdown::render("CodeTemplates/12-BayesMCMC.R", envir = globalenv())
